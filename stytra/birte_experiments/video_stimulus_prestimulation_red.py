...
class VideoProtocol(Protocol):
    name = "video_stimulus_prestimulation_red"
    def __init__(self):
        super().__init__()

        # List all stimuli
        json_paths = r"assets/stim_videos/20250701_prestimulation_red/"
    ...
    def get_stim_sequence(self):
        ...
        path = os.path.join('stim_videos', '20250701_prestimulation_red', video_name + '.mp4')
